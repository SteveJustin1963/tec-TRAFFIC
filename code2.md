...
:A
  s 0 = (       // If state equals 0
    4 L         // Output NS green, EW red
    t 300 > (   // If timer > 300
      1 s! R    // Set state to 1 and reset timer
    )
  )
;
...
:B
  s 1 = (       // If state equals 1
    2 L         // Output NS yellow, EW red
    t 50 > (    // If timer > 50
      2 s! R    // Set state to 2 and reset timer
    )
  )
;
...
:C
  s 2 = (       // If state equals 2
    9 L         // Output all red
    t 20 > (    // If timer > 20
      3 s! R    // Set state to 3 and reset timer
    )
  )
;
...
:E
  s 3 = (       // If state equals 3
    1 L         // Output EW green, NS red
    t 300 > (   // If timer > 300
      4 s! R    // Set state to 4 and reset timer
    )
  )
;
...
:F
  s 4 = (       // If state equals 4
    8 L         // Output EW yellow, NS red
    t 50 > (    // If timer > 50
      5 s! R    // Set state to 5 and reset timer
    )
  )
;
...
:H
  s 5 = (       // If state equals 5
    9 L         // Output all red
    t 20 > (    // If timer > 20
      0 s! R    // Set state to 0 and reset timer
    )
  )
;
